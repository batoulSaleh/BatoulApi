...
use App\Http\Controllers\dashboard\CategoryyController;
use App\Http\Controllers\dashboard\CleaningController;
use App\Http\Controllers\dashboard\ProductController;
use App\Http\Controllers\dashboard\ProducttController;
...
Route::prefix('/dashboard')->name('admin.')->group(function (){
    ...
    Route::middleware('admin')->group(function () {
        ...
        //end categories routes
         ...
         Route::get('/categoryy/index',[CategoryyController::class,'index'])->name('categoryy.index');
         Route::get('/categoryy/create',[CategoryyController::class,'create'])->name('categoryy.create');
         Route::post('/categoryy/store',[CategoryyController::class,'store'])->name('categoryy.store');
         Route::get('/categoryy/edit/{id}',[CategoryyController::class,'edit'])->name('categoryy.edit');
         Route::post('/categoryy/update',[CategoryyController::class,'update'])->name('categoryy.update');
         Route::get('/categoryy/delete/{id}',[CategoryyController::class,'delete'])->name('categoryy.delete');
        ...
        //end product routes
         ...
         Route::get('/productt/index',[ProducttController::class,'index'])->name('productt.index');
         Route::get('/productt/create',[ProducttController::class,'create'])->name('productt.create');
         Route::post('/productt/store',[ProducttController::class,'store'])->name('productt.store');
         Route::get('/productt/edit/{id}',[ProducttController::class,'edit'])->name('productt.edit');
         Route::get('/productt/delete/{id}',[ProducttController::class,'delete'])->name('productt.delete');
