...
use App\Http\Controllers\Api\V1\CarttController;
use App\Http\Controllers\Api\V1\CategoyController;
use App\Http\Controllers\Api\V1\CategoryyController;
...
use App\Http\Controllers\Api\V1\OrderrController;
use Illuminate\Http\Request;
use App\Http\Controllers\Api\V1\password\ForgotPasswordController;
use App\Http\Controllers\Api\V1\ProductController;
use App\Http\Controllers\Api\V1\ProducttController;
...
// Categories start
    Route::get('/categoriess/index',[CategoryyController::class,'index']);
    Route::get('/categoriess/show/{id}',[CategoryyController::class,'show']);    
    // Categories end

    //products start
    Route::get('/productt/index',[ProducttController::class,'index']);
    Route::get('/productt/show/{id}',[ProducttController::class,'show']);
    Route::get('/productt/category/{cat_id}',[ProducttController::class,'CategoriesProduct']);
    //products end

       //cart start

    //   user start
    Route::post('/cartt/user/store',[CarttController::class,'userstore'])->middleware('auth:sanctum');
    Route::get('/cartt/user/index',[CarttController::class,'userindex'])->middleware('auth:sanctum');
    Route::post('/cartt/user/update/{id}',[CarttController::class,'userupdate'])->middleware('auth:sanctum');
    Route::post('/cartt/user/delete/{id}',[CarttController::class,'userdelete'])->middleware('auth:sanctum');
    Route::get('/cartt/user/count',[CarttController::class,'usercount'])->middleware('auth:sanctum');
    Route::post('/orderr/user/store',[OrderrController::class,'userstore'])->middleware('auth:sanctum');
    Route::post('/orderr/user/index',[OrderrController::class,'myorders'])->middleware('auth:sanctum');
