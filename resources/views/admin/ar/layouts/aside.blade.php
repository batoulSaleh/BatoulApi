      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.categoryy.index') }}" class="nav-link {{ (Route::currentRouteName() == 'admin.categoryy.index') ? 'active' : "" }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p> All categories</p>
              ...
              <li class="nav-item">
                <a href="{{ route('admin.categoryy.create') }}" class="nav-link {{ (Route::currentRouteName() == 'admin.categoryy.create') ? 'active' : "" }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Category</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.productt.index') }}" class="nav-link {{ (Route::currentRouteName() == 'admin.productt.index') ? 'active' : "" }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p> All products</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('admin.productt.create') }}" class="nav-link {{ (Route::currentRouteName() == 'admin.productt.create') ? 'active' : "" }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Add Product</p>
                </a>
              </li>
