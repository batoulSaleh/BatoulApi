    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style="float: right;">All Products </h3><br/>
          <a href="{{ route('admin.productt.create') }}" style="float: right" class="btn btn-info">Add Product </a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<tr>
    <td>{{ $product->id }}</td>
      ...
      <td>
        <a href="{{ route('admin.productt.edit',$product->id) }}" class="btn btn-info sm"><i class=" fas fa-edit"></i></a>
        <br>
        <a href="{{ route('admin.productt.delete',$product->id) }}" id="delete" class="btn btn-danger sm"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>
