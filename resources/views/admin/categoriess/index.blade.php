    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('admin.categoryy.create') }}" style="float: left" class="btn btn-info"> add category</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<tr>
    <td>{{ $category->id }}</td>
      <td>{{ $category->name }}</td>
      <td>
        <a href="{{ route('admin.categoryy.edit',$category->id) }}" class="btn btn-info sm"><i class=" fas fa-edit"></i></a>
        <br>
        <a href="{{ route('admin.categoryy.delete',$category->id) }}" id="delete" class="btn btn-danger sm"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>
